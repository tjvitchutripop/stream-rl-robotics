...
if __name__ == "__main__":
    ...
    optimizer_policy = ObGD(list(agent.actor_mean.parameters()) + [agent.actor_logstd], lr=1.0, gamma=0.99, lamda=0.8, kappa=3.0)
    optimizer_value = ObGD(agent.critic.parameters(), lr=1.0, gamma=0.99, lamda=0.8, kappa=2.0)
