...
if __name__ == '__main__':
    ...
    parser.add_argument('--damage_type', type=str, default='arm_hand_impairment',
                        choices=['broken_leg', 'stuck_joint', 'slippery_floor', 'slippery_floor_easy', 'goal_shift', 'goal_shift_easy', 'arm_hand_impairment'],
