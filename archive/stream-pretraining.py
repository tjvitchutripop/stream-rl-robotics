...
class DamageCallback(BaseCallback):
    ...
    def __init__(self, do_damage=False, damage_start_step=100_000, damage_steps=100_000, 
        ...
        self.damaged_leg = 0
        self.damaged_joints = []
        self.damage_leg_sequence = [2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 2]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_envs", type=int, default=10) # set to 1 for direct comparison with stream_ac.py
    ...
    if "Ant" in base_args.env:
        env_specific_parser.add_argument("--do_damage", action="store_true", 
                                        help="Enable damage to the Ant environment", default=False)
        env_specific_parser.add_argument("--damage_start_step", type=int, default=500_000, 
