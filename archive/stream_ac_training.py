...
class StreamACRunner:
    ...
    def train(self):
        ...
        self.agent.load_state_dict(torch.load("/home/tj/Documents/stream-rl-quadruped/runs/AnymalC-Reach-v1__ppo_stream_pretrain_obgd__1__1755726847/ckpt_226.pt")) # prev /home/tj/Documents/apollo-streaming-rl/runs/AnymalC-Reach-v1__ppo_stream_pretrain__1__1752786867/final_ckpt.pt
        if self.debug:
