...
class Args:
    ...
    wandb_project_name: str = "stream-rl"
...
if __name__ == "__main__":
    ...
    for update in range(1, num_updates + 1):
        # Calculate the current global step based on the update and num_envs
        global_step = update * args.num_envs
        ...
        if global_step > args.learning_starts:
            ...
            for gradient_step in range(gradient_steps):
                ...
                if (update * gradient_steps + gradient_step) % args.policy_frequency == 0:
                    for _ in range(
                ...
                if (update * gradient_steps + gradient_step) % args.target_network_frequency == 0:
